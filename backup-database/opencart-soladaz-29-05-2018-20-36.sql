...
--
-- Host: localhost:3306
-- Generation Time: May 29, 2018 at 08:35 PM
...
--
-- Database: `opencart-soladaz`
--

-- --------------------------------------------------------

--
-- Table structure for table `soladaz_address`
--

CREATE TABLE `soladaz_address` (
...
--
-- Table structure for table `soladaz_api`
--

CREATE TABLE `soladaz_api` (
...
--
-- Dumping data for table `soladaz_api`
--

INSERT INTO `soladaz_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2018-05-29 18:43:14', '2018-05-29 18:43:14');

-- --------------------------------------------------------

--
-- Table structure for table `soladaz_api_ip`
--

CREATE TABLE `soladaz_api_ip` (
...
--
-- Table structure for table `soladaz_api_session`
--

CREATE TABLE `soladaz_api_session` (
...
--
-- Table structure for table `soladaz_attribute`
--

CREATE TABLE `soladaz_attribute` (
...
--
-- Dumping data for table `soladaz_attribute`
--

INSERT INTO `soladaz_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Table structure for table `soladaz_attribute_description`
--

CREATE TABLE `soladaz_attribute_description` (
  `attribute_id` int(11) NOT NULL,
...
--
-- Dumping data for table `soladaz_attribute_description`
--

INSERT INTO `soladaz_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(4, 1, 'test 1'),
(5, 1, 'test 2'),
...
--
-- Table structure for table `soladaz_attribute_group`
--

CREATE TABLE `soladaz_attribute_group` (
  `attribute_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_attribute_group`
--

INSERT INTO `soladaz_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Table structure for table `soladaz_attribute_group_description`
--

CREATE TABLE `soladaz_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `soladaz_attribute_group_description`
--

INSERT INTO `soladaz_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor');
...
--
-- Table structure for table `soladaz_banner`
--

CREATE TABLE `soladaz_banner` (
...
--
-- Dumping data for table `soladaz_banner`
--

INSERT INTO `soladaz_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
...
--
-- Table structure for table `soladaz_banner_image`
--

CREATE TABLE `soladaz_banner_image` (
...
--
-- Dumping data for table `soladaz_banner_image`
--

INSERT INTO `soladaz_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `soladaz_cart`
--

CREATE TABLE `soladaz_cart` (
...
--
-- Table structure for table `soladaz_category`
--

CREATE TABLE `soladaz_category` (
...
--
-- Dumping data for table `soladaz_category`
--

INSERT INTO `soladaz_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `soladaz_category_description`
--

CREATE TABLE `soladaz_category_description` (
  `category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `soladaz_category_description`
--

INSERT INTO `soladaz_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `soladaz_category_filter`
--

CREATE TABLE `soladaz_category_filter` (
  `category_id` int(11) NOT NULL,
...
--
-- Table structure for table `soladaz_category_path`
--

CREATE TABLE `soladaz_category_path` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `soladaz_category_path`
--

INSERT INTO `soladaz_category_path` (`category_id`, `path_id`, `level`) VALUES
(25, 25, 0),
(28, 25, 0),
(28, 28, 1),
(35, 25, 0),
...
--
-- Table structure for table `soladaz_category_to_layout`
--

CREATE TABLE `soladaz_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
--
-- Table structure for table `soladaz_category_to_store`
--

CREATE TABLE `soladaz_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_category_to_store`
--

INSERT INTO `soladaz_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
--
-- Table structure for table `soladaz_country`
--

CREATE TABLE `soladaz_country` (
...
--
-- Dumping data for table `soladaz_country`
--

INSERT INTO `soladaz_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
--
-- Table structure for table `soladaz_coupon`
--

CREATE TABLE `soladaz_coupon` (
...
--
-- Dumping data for table `soladaz_coupon`
--

INSERT INTO `soladaz_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `soladaz_coupon_category`
--

CREATE TABLE `soladaz_coupon_category` (
  `coupon_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_coupon_history`
--

CREATE TABLE `soladaz_coupon_history` (
...
--
-- Table structure for table `soladaz_coupon_product`
--

CREATE TABLE `soladaz_coupon_product` (
...
--
-- Table structure for table `soladaz_currency`
--

CREATE TABLE `soladaz_currency` (
...
--
-- Dumping data for table `soladaz_currency`
--

INSERT INTO `soladaz_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.61250001, 1, '2014-09-25 14:40:00'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2018-05-29 21:51:23'),
(3, 'Euro', 'EUR', '', '€', '2', 0.78460002, 1, '2014-09-25 14:40:00');

-- --------------------------------------------------------

--
-- Table structure for table `soladaz_customer`
--

CREATE TABLE `soladaz_customer` (
  `customer_id` int(11) NOT NULL,
...
--
-- Table structure for table `soladaz_customer_activity`
--

CREATE TABLE `soladaz_customer_activity` (
...
--
-- Table structure for table `soladaz_customer_affiliate`
--

CREATE TABLE `soladaz_customer_affiliate` (
  `customer_id` int(11) NOT NULL,
  `company` varchar(40) NOT NULL,
...
--
-- Table structure for table `soladaz_customer_approval`
--

CREATE TABLE `soladaz_customer_approval` (
...
--
-- Table structure for table `soladaz_customer_group`
--

CREATE TABLE `soladaz_customer_group` (
  `customer_group_id` int(11) NOT NULL,
...
--
-- Dumping data for table `soladaz_customer_group`
--

INSERT INTO `soladaz_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `soladaz_customer_group_description`
--

CREATE TABLE `soladaz_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `soladaz_customer_group_description`
--

INSERT INTO `soladaz_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Default', 'test');

-- --------------------------------------------------------

--
-- Table structure for table `soladaz_customer_history`
--

CREATE TABLE `soladaz_customer_history` (
...
--
-- Table structure for table `soladaz_customer_ip`
--

CREATE TABLE `soladaz_customer_ip` (
...
--
-- Table structure for table `soladaz_customer_login`
--

CREATE TABLE `soladaz_customer_login` (
...
--
-- Table structure for table `soladaz_customer_online`
--

CREATE TABLE `soladaz_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
--
-- Table structure for table `soladaz_customer_reward`
--

CREATE TABLE `soladaz_customer_reward` (
...
--
-- Table structure for table `soladaz_customer_search`
--

CREATE TABLE `soladaz_customer_search` (
...
--
-- Table structure for table `soladaz_customer_transaction`
--

CREATE TABLE `soladaz_customer_transaction` (
...
--
-- Table structure for table `soladaz_customer_wishlist`
--

CREATE TABLE `soladaz_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_custom_field`
--

CREATE TABLE `soladaz_custom_field` (
...
--
-- Table structure for table `soladaz_custom_field_customer_group`
--

CREATE TABLE `soladaz_custom_field_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- Table structure for table `soladaz_custom_field_description`
--

CREATE TABLE `soladaz_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_custom_field_value`
--

CREATE TABLE `soladaz_custom_field_value` (
...
--
-- Table structure for table `soladaz_custom_field_value_description`
--

CREATE TABLE `soladaz_custom_field_value_description` (
  `custom_field_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
--
-- Table structure for table `soladaz_download`
--

CREATE TABLE `soladaz_download` (
...
--
-- Table structure for table `soladaz_download_description`
--

CREATE TABLE `soladaz_download_description` (
  `download_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_event`
--

CREATE TABLE `soladaz_event` (
...
--
-- Dumping data for table `soladaz_event`
--

INSERT INTO `soladaz_event` (`event_id`, `code`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `soladaz_extension`
--

CREATE TABLE `soladaz_extension` (
...
--
-- Dumping data for table `soladaz_extension`
--

INSERT INTO `soladaz_extension` (`extension_id`, `type`, `code`) VALUES
(1, 'payment', 'cod'),
(2, 'total', 'shipping'),
(3, 'total', 'sub_total'),
(4, 'total', 'tax'),
...
--
-- Table structure for table `soladaz_extension_install`
--

CREATE TABLE `soladaz_extension_install` (
...
--
-- Table structure for table `soladaz_extension_path`
--

CREATE TABLE `soladaz_extension_path` (
...
--
-- Table structure for table `soladaz_filter`
--

CREATE TABLE `soladaz_filter` (
  `filter_id` int(11) NOT NULL,
...
--
-- Table structure for table `soladaz_filter_description`
--

CREATE TABLE `soladaz_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
...
--
-- Table structure for table `soladaz_filter_group`
--

CREATE TABLE `soladaz_filter_group` (
  `filter_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_filter_group_description`
--

CREATE TABLE `soladaz_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_geo_zone`
--

CREATE TABLE `soladaz_geo_zone` (
...
--
-- Dumping data for table `soladaz_geo_zone`
--

INSERT INTO `soladaz_geo_zone` (`geo_zone_id`, `name`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `soladaz_information`
--

CREATE TABLE `soladaz_information` (
...
--
-- Dumping data for table `soladaz_information`
--

INSERT INTO `soladaz_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(3, 1, 3, 1),
(4, 1, 1, 1),
(5, 1, 4, 1),
(6, 1, 2, 1);
...
--
-- Table structure for table `soladaz_information_description`
--

CREATE TABLE `soladaz_information_description` (
  `information_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(64) NOT NULL,
...
--
-- Dumping data for table `soladaz_information_description`
--

INSERT INTO `soladaz_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(4, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n', 'About Us', '', ''),
...
--
-- Table structure for table `soladaz_information_to_layout`
--

CREATE TABLE `soladaz_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_information_to_store`
--

CREATE TABLE `soladaz_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_information_to_store`
--

INSERT INTO `soladaz_information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0);
...
--
-- Table structure for table `soladaz_language`
--

CREATE TABLE `soladaz_language` (
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
--
-- Dumping data for table `soladaz_language`
--

INSERT INTO `soladaz_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `sort_order`, `status`) VALUES
(1, 'English', 'en-gb', 'en-US,en_US.UTF-8,en_US,en-gb,english', 'gb.png', 'english', 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `soladaz_layout`
--

CREATE TABLE `soladaz_layout` (
  `layout_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_layout`
--

INSERT INTO `soladaz_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- Table structure for table `soladaz_layout_module`
--

CREATE TABLE `soladaz_layout_module` (
...
--
-- Dumping data for table `soladaz_layout_module`
--

INSERT INTO `soladaz_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
...
--
-- Table structure for table `soladaz_layout_route`
--

CREATE TABLE `soladaz_layout_route` (
...
--
-- Dumping data for table `soladaz_layout_route`
--

INSERT INTO `soladaz_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(38, 6, 0, 'account/%'),
(17, 10, 0, 'affiliate/%'),
...
--
-- Table structure for table `soladaz_length_class`
--

CREATE TABLE `soladaz_length_class` (
  `length_class_id` int(11) NOT NULL,
  `value` decimal(15,8) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_length_class`
--

INSERT INTO `soladaz_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- Table structure for table `soladaz_length_class_description`
--

CREATE TABLE `soladaz_length_class_description` (
  `length_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
...
--
-- Dumping data for table `soladaz_length_class_description`
--

INSERT INTO `soladaz_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
--
-- Table structure for table `soladaz_location`
--

CREATE TABLE `soladaz_location` (
...
--
-- Table structure for table `soladaz_manufacturer`
--

CREATE TABLE `soladaz_manufacturer` (
...
--
-- Dumping data for table `soladaz_manufacturer`
--

INSERT INTO `soladaz_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `soladaz_manufacturer_to_store`
--

CREATE TABLE `soladaz_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_manufacturer_to_store`
--

INSERT INTO `soladaz_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Table structure for table `soladaz_marketing`
--

CREATE TABLE `soladaz_marketing` (
...
--
-- Table structure for table `soladaz_modification`
--

CREATE TABLE `soladaz_modification` (
...
--
-- Dumping data for table `soladaz_modification`
--

INSERT INTO `soladaz_modification` (`modification_id`, `extension_install_id`, `name`, `code`, `author`, `version`, `link`, `xml`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `soladaz_module`
--

CREATE TABLE `soladaz_module` (
...
--
-- Dumping data for table `soladaz_module`
--

INSERT INTO `soladaz_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
--
-- Table structure for table `soladaz_option`
--

CREATE TABLE `soladaz_option` (
...
--
-- Dumping data for table `soladaz_option`
--

INSERT INTO `soladaz_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 1),
(2, 'checkbox', 2),
(4, 'text', 3),
(5, 'select', 4),
...
--
-- Table structure for table `soladaz_option_description`
--

CREATE TABLE `soladaz_option_description` (
  `option_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `soladaz_option_description`
--

INSERT INTO `soladaz_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(6, 1, 'Textarea'),
...
--
-- Table structure for table `soladaz_option_value`
--

CREATE TABLE `soladaz_option_value` (
...
--
-- Dumping data for table `soladaz_option_value`
--

INSERT INTO `soladaz_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43, 1, '', 3),
(32, 1, '', 1),
(45, 2, '', 4),
(44, 2, '', 3),
...
--
-- Table structure for table `soladaz_option_value_description`
--

CREATE TABLE `soladaz_option_value_description` (
  `option_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
--
-- Dumping data for table `soladaz_option_value_description`
--

INSERT INTO `soladaz_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43, 1, 1, 'Large'),
(32, 1, 1, 'Small'),
(45, 1, 2, 'Checkbox 4'),
(44, 1, 2, 'Checkbox 3'),
...
--
-- Table structure for table `soladaz_order`
--

CREATE TABLE `soladaz_order` (
  `order_id` int(11) NOT NULL,
...
--
-- Table structure for table `soladaz_order_history`
--

CREATE TABLE `soladaz_order_history` (
...
--
-- Table structure for table `soladaz_order_option`
--

CREATE TABLE `soladaz_order_option` (
...
--
-- Table structure for table `soladaz_order_product`
--

CREATE TABLE `soladaz_order_product` (
  `order_product_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `soladaz_order_recurring`
--

CREATE TABLE `soladaz_order_recurring` (
...
--
-- Table structure for table `soladaz_order_recurring_transaction`
--

CREATE TABLE `soladaz_order_recurring_transaction` (
...
--
-- Table structure for table `soladaz_order_shipment`
--

CREATE TABLE `soladaz_order_shipment` (
...
--
-- Table structure for table `soladaz_order_status`
--

CREATE TABLE `soladaz_order_status` (
  `order_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `soladaz_order_status`
--

INSERT INTO `soladaz_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(7, 1, 'Canceled'),
(5, 1, 'Complete'),
...
--
-- Table structure for table `soladaz_order_total`
--

CREATE TABLE `soladaz_order_total` (
...
--
-- Table structure for table `soladaz_order_voucher`
--

CREATE TABLE `soladaz_order_voucher` (
...
--
-- Table structure for table `soladaz_product`
--

CREATE TABLE `soladaz_product` (
  `product_id` int(11) NOT NULL,
  `model` varchar(64) NOT NULL,
...
--
-- Dumping data for table `soladaz_product`
--

INSERT INTO `soladaz_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `soladaz_product_attribute`
--

CREATE TABLE `soladaz_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL
...
--
-- Dumping data for table `soladaz_product_attribute`
--

INSERT INTO `soladaz_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 4, 1, '16GB'),
(43, 4, 1, '8gb'),
(42, 3, 1, '100mhz'),
...
--
-- Table structure for table `soladaz_product_description`
--

CREATE TABLE `soladaz_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
  ...
  `meta_description` varchar(255) NOT NULL,
  `meta_keyword` varchar(255) NOT NULL,
  `video` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `soladaz_product_description`
--

INSERT INTO `soladaz_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`, `video`, `html_product_tab`, `tab_title`) VALUES
(35, 1, 'Product 8', '&lt;p&gt;\r\n	Product 8&lt;/p&gt;\r\n', '', 'Product 8', '', '', '', '', ''),
...
--
-- Table structure for table `soladaz_product_discount`
--

CREATE TABLE `soladaz_product_discount` (
...
--
-- Dumping data for table `soladaz_product_discount`
--

INSERT INTO `soladaz_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `soladaz_product_filter`
--

CREATE TABLE `soladaz_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_product_image`
--

CREATE TABLE `soladaz_product_image` (
...
--
-- Dumping data for table `soladaz_product_image`
--

INSERT INTO `soladaz_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `soladaz_product_option`
--

CREATE TABLE `soladaz_product_option` (
  `product_option_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `value` text NOT NULL,
...
--
-- Dumping data for table `soladaz_product_option`
--

INSERT INTO `soladaz_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224, 35, 11, '', 1),
...
--
-- Table structure for table `soladaz_product_option_value`
--

CREATE TABLE `soladaz_product_option_value` (
...
--
-- Dumping data for table `soladaz_product_option_value`
--

INSERT INTO `soladaz_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Table structure for table `soladaz_product_recurring`
--

CREATE TABLE `soladaz_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_product_related`
--

CREATE TABLE `soladaz_product_related` (
  `product_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_product_related`
--

INSERT INTO `soladaz_product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Table structure for table `soladaz_product_reward`
--

CREATE TABLE `soladaz_product_reward` (
...
--
-- Dumping data for table `soladaz_product_reward`
--

INSERT INTO `soladaz_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515, 42, 1, 100),
(519, 47, 1, 300),
(379, 28, 1, 400),
(329, 43, 1, 600),
...
--
-- Table structure for table `soladaz_product_special`
--

CREATE TABLE `soladaz_product_special` (
...
--
-- Dumping data for table `soladaz_product_special`
--

INSERT INTO `soladaz_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `soladaz_product_to_category`
--

CREATE TABLE `soladaz_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_product_to_category`
--

INSERT INTO `soladaz_product_to_category` (`product_id`, `category_id`) VALUES
(28, 20),
(28, 24),
(29, 20),
(29, 24),
...
--
-- Table structure for table `soladaz_product_to_download`
--

CREATE TABLE `soladaz_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_product_to_layout`
--

CREATE TABLE `soladaz_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_product_to_store`
--

CREATE TABLE `soladaz_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_product_to_store`
--

INSERT INTO `soladaz_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- Table structure for table `soladaz_recurring`
--

CREATE TABLE `soladaz_recurring` (
  `recurring_id` int(11) NOT NULL,
...
--
-- Table structure for table `soladaz_recurring_description`
--

CREATE TABLE `soladaz_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `soladaz_return`
--

CREATE TABLE `soladaz_return` (
...
--
-- Table structure for table `soladaz_return_action`
--

CREATE TABLE `soladaz_return_action` (
  `return_action_id` int(11) NOT NULL,
...
--
-- Dumping data for table `soladaz_return_action`
--

INSERT INTO `soladaz_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 1, 'Refunded'),
(2, 1, 'Credit Issued'),
...
--
-- Table structure for table `soladaz_return_history`
--

CREATE TABLE `soladaz_return_history` (
...
--
-- Table structure for table `soladaz_return_reason`
--

CREATE TABLE `soladaz_return_reason` (
  `return_reason_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `soladaz_return_reason`
--

INSERT INTO `soladaz_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
--
-- Table structure for table `soladaz_return_status`
--

CREATE TABLE `soladaz_return_status` (
  `return_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `soladaz_return_status`
--

INSERT INTO `soladaz_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(3, 1, 'Complete'),
...
--
-- Table structure for table `soladaz_review`
--

CREATE TABLE `soladaz_review` (
...
--
-- Table structure for table `soladaz_seo_url`
--

CREATE TABLE `soladaz_seo_url` (
...
--
-- Dumping data for table `soladaz_seo_url`
--

INSERT INTO `soladaz_seo_url` (`seo_url_id`, `store_id`, `language_id`, `query`, `keyword`) VALUES
...
--
-- Table structure for table `soladaz_session`
--

CREATE TABLE `soladaz_session` (
  `session_id` varchar(32) NOT NULL,
  `data` text NOT NULL,
...
--
-- Dumping data for table `soladaz_session`
--

INSERT INTO `soladaz_session` (`session_id`, `data`, `expire`) VALUES
('01cf9f171b0622eace41ffb01e', '{\"user_id\":\"1\",\"user_token\":\"fhercDOywZgVfVcnUT9dYuyVjdHvQFaX\",\"language\":\"en-gb\",\"currency\":\"USD\",\"device\":\"desktop\"}', '2018-05-29 22:36:43');

-- --------------------------------------------------------

--
-- Table structure for table `soladaz_setting`
--

CREATE TABLE `soladaz_setting` (
...
--
-- Dumping data for table `soladaz_setting`
--

INSERT INTO `soladaz_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
...
(42, 0, 'config', 'config_invoice_prefix', 'INV-2018-00', 0),
...
(201, 0, 'config', 'config_email', 'danilonewtrue@gmail.com', 0),
...
(202, 0, 'config', 'config_encryption', '', 0),
...
(8024, 0, 'theme_default', 'theme_default_image_cart_height', '47', 0),
(8025, 0, 'theme_default', 'theme_default_image_location_width', '268', 0),
(8023, 0, 'theme_default', 'theme_default_image_cart_width', '47', 0),
(8022, 0, 'theme_default', 'theme_default_image_wishlist_height', '47', 0),
(8021, 0, 'theme_default', 'theme_default_image_wishlist_width', '47', 0),
(8020, 0, 'theme_default', 'theme_default_image_compare_height', '90', 0),
(8019, 0, 'theme_default', 'theme_default_image_compare_width', '90', 0),
(8018, 0, 'theme_default', 'theme_default_image_related_height', '270', 0),
(8017, 0, 'theme_default', 'theme_default_image_related_width', '270', 0),
(8016, 0, 'theme_default', 'theme_default_image_additional_height', '270', 0),
(8014, 0, 'theme_default', 'theme_default_image_product_height', '270', 0),
(8015, 0, 'theme_default', 'theme_default_image_additional_width', '270', 0),
(8013, 0, 'theme_default', 'theme_default_image_product_width', '270', 0),
(8012, 0, 'theme_default', 'theme_default_image_popup_height', '1000', 0),
(8010, 0, 'theme_default', 'theme_default_image_thumb_height', '150', 0),
(8011, 0, 'theme_default', 'theme_default_image_popup_width', '1000', 0),
(8009, 0, 'theme_default', 'theme_default_image_thumb_width', '150', 0),
(8008, 0, 'theme_default', 'theme_default_image_category_height', '270', 0),
(8007, 0, 'theme_default', 'theme_default_image_category_width', '270', 0),
...
(8006, 0, 'theme_default', 'theme_default_product_description_length', '350', 0),
(8005, 0, 'theme_default', 'theme_default_product_limit', '15', 0),
(8004, 0, 'theme_default', 'theme_default_status', '1', 0),
(8003, 0, 'theme_default', 'theme_default_directory', 'so-ladaz', 0),
(8026, 0, 'theme_default', 'theme_default_image_location_height', '50', 0);

-- --------------------------------------------------------

--
-- Table structure for table `soladaz_shipping_courier`
--

CREATE TABLE `soladaz_shipping_courier` (
...
--
-- Dumping data for table `soladaz_shipping_courier`
--

INSERT INTO `soladaz_shipping_courier` (`shipping_courier_id`, `shipping_courier_code`, `shipping_courier_name`) VALUES
(1, 'dhl', 'DHL'),
(2, 'fedex', 'Fedex'),
(3, 'ups', 'UPS'),
...
--
-- Table structure for table `soladaz_simple_blog_category`
--

CREATE TABLE `soladaz_simple_blog_category` (
...
--
-- Dumping data for table `soladaz_simple_blog_category`
--

INSERT INTO `soladaz_simple_blog_category` (`simple_blog_category_id`, `image`, `parent_id`, `top`, `blog_category_column`, `external_link`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `soladaz_simple_blog_category_description`
--

CREATE TABLE `soladaz_simple_blog_category_description` (
...
--
-- Dumping data for table `soladaz_simple_blog_category_description`
--

INSERT INTO `soladaz_simple_blog_category_description` (`simple_blog_category_description_id`, `simple_blog_category_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `soladaz_soconfig`
--

CREATE TABLE `soladaz_soconfig` (
  `id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `soladaz_soconfig`
--

INSERT INTO `soladaz_soconfig` (`id`, `store_id`, `key`, `value`, `serialized`) VALUES
(71334, 0, 'soconfig_custom_store', '{\"cssinput_status\":\"0\",\"cssinput_content\":\"\",\"cssfile_status\":\"0\",\"cssfile_url\":[\"catalog\\/view\\/theme\\/so-revo\\/css\\/custom.css\"],\"jsinput_status\":\"0\",\"jsinput_content\":\"\"}', 1),
(71332, 0, 'soconfig_fonts_store', '{\"body_status\":\"google\",\"normal_body\":\"Arial, Helvetica, sans-serif\",\"url_body\":\"https:\\/\\/fonts.googleapis.com\\/css?family=Roboto:300,400,400i,500,500i,700\",\"family_body\":\"\'Roboto\', sans-serif\",\"selector_body\":\"body, #wrapper\",\"menu_status\":\"standard\",\"normal_menu\":\"inherit\",\"url_menu\":\"https:\\/\\/fonts.googleapis.com\\/css?family=Roboto:300,400,500,700\",\"family_menu\":\"\'Roboto\', sans-serif\",\"selector_menu\":\"\",\"heading_status\":\"standard\",\"normal_heading\":\"inherit\",\"url_heading\":\"\",\"family_heading\":\"\",\"selector_heading\":\"\"}', 1),
(71333, 0, 'soconfig_social_store', '{\"social_sidebar\":\"0\",\"social_fb_status\":\"0\",\"facebook\":\"magentech\",\"social_twitter_status\":\"0\",\"twitter\":\"smartaddons\",\"social_custom_status\":\"0\",\"video_code\":{\"1\":\"&lt;h3&gt;Guide Create Social Wickgets&amp;nbsp;&lt;\\/h3&gt;\\r\\n&lt;p&gt;You please login admin, then select\\r\\n&lt;span style=&quot;font-weight: bold;&quot;&gt;&amp;nbsp;Extension tab &amp;gt; Modules &amp;gt; Theme Control Panel &amp;gt; Tab Social Wickgets:&lt;\\/span&gt;\\r\\nPlease enter data content&lt;\\/p&gt;\"}}', 1),
(71330, 0, 'soconfig_layout_store', '{\"layoutstyle\":\"full\",\"theme_bgcolor\":\"#7a167a\",\"pattern\":\"6\",\"contentbg\":\"\",\"content_bg_mode\":\"repeat\",\"content_attachment\":\"scroll\"}', 1),
(71331, 0, 'soconfig_pages_store', '{\"catalog_col_position\":\"outside\",\"catalog_col_type\":\"default\",\"catalog_sidebar_sticky\":\"disable\",\"product_catalog_refine\":\"2\",\"catalog_refine_number\":\"5\",\"lstimg_cate_status\":\"1\",\"product_catalog_mode\":\"grid-4\",\"discount_status\":\"1\",\"countdown_status\":\"1\",\"rating_status\":\"1\",\"product_order\":\"1\",\"card_gallery\":\"2\",\"placeholder_status\":\"1\",\"placeholder_img\":\"\",\"desktop_addcart_position\":\"left\",\"quick_status\":\"1\",\"desktop_addcart_status\":\"1\",\"desktop_wishlist_status\":\"1\",\"desktop_Compare_status\":\"1\",\"radio_style\":\"1\",\"thumbnails_position\":\"bottom\",\"product_enablezoom\":\"1\",\"product_enablesizechart\":\"0\",\"tabs_position\":\"2\",\"product_enableshowmore\":\"0\",\"product_enableshipping\":\"1\",\"product_contentshipping\":{\"1\":\"\"},\"product_page_button\":\"1\",\"product_socialshare\":{\"1\":\"&lt;div class=&quot;title-share&quot;&gt;Share This&lt;\\/div&gt;\\r\\n&lt;div class=&quot;wrap-content&quot;&gt;&lt;div class=&quot;addthis_inline_share_toolbox&quot;&gt;&lt;\\/div&gt;&lt;\\/div&gt;\"},\"related_status\":\"1\",\"product_related_column_lg\":\"5\",\"product_related_column_md\":\"3\",\"product_related_column_sm\":\"3\",\"product_related_column_xs\":\"1\",\"comingsoon_imglogo\":\"\",\"comingsoon_title\":{\"1\":\"\"},\"comingsoon_date\":\"\",\"comingsoon_content\":{\"1\":\"\"}}', 1),
(71328, 0, 'soconfig_general_store', '{\"typelayout\":\"1\",\"themecolor\":\"orange\",\"toppanel_status\":\"1\",\"toppanel_type\":\"3\",\"phone_status\":\"1\",\"contact_number\":{\"1\":\"&lt;b&gt;Hotline:&lt;\\/b&gt;(801) 2345 - 6789\"},\"welcome_message_status\":\"1\",\"welcome_message\":{\"1\":\"&lt;div class=&quot;list-msg&quot;&gt; &lt;div class=&quot;list-msg--item&quot;&gt;&lt;label class=&quot;label-msg&quot;&gt;This week&lt;\\/label&gt; &lt;a href=&quot;#&quot;&gt;Sale special too good gear category&lt;\\/a&gt;&lt;\\/div&gt; &lt;div class=&quot;list-msg--item&quot;&gt;&lt;label class=&quot;label-msg&quot;&gt;Tomorrow&lt;\\/label&gt; &lt;a href=&quot;#&quot;&gt;Laten ipsum dolor sit amet.In gravida pellentesque&lt;\\/a&gt;&lt;\\/div&gt; &lt;\\/div&gt;\"},\"checkout_status\":\"1\",\"lang_status\":\"1\",\"preloader\":\"1\",\"preloader_animation\":\"line\",\"backtop\":\"1\",\"imgpayment_status\":\"1\",\"imgpayment\":\"catalog\\/demo\\/payment\\/payment-4.png\",\"copyright\":\"So Ladaz \\u00a9 2016 - {year} Opencart Themes Demo Store. All Rights Reserved. Designed by &lt;a href=&quot;http:\\/\\/www.opencartworks.com\\/&quot; target=&quot;_blank&quot;&gt;OpenCartWorks.Com&lt;\\/a&gt;\",\"typeheader\":\"1\",\"typefooter\":\"1\",\"type_banner\":\"7\",\"img_sizechart\":\"\"}', 1),
(71329, 0, 'soconfig_advanced_store', '{\"name_color\":\"yellow\",\"theme_color\":\"#ff9600\",\"scsscompile\":\"0\",\"scssformat\":\"Nested\",\"compileMutiColor\":\"0\",\"cssminify\":\"0\",\"cssExclude\":[{\"namecss\":\"catalog\\/view\\/javascript\\/font-awesome\\/css\\/font-awesome.min.css\"}],\"jsminify\":\"0\"}', 1);

-- --------------------------------------------------------

--
-- Table structure for table `soladaz_statistics`
--

CREATE TABLE `soladaz_statistics` (
...
--
-- Dumping data for table `soladaz_statistics`
--

INSERT INTO `soladaz_statistics` (`statistics_id`, `code`, `value`) VALUES
(1, 'order_sale', '0.0000'),
...
--
-- Table structure for table `soladaz_stock_status`
--

CREATE TABLE `soladaz_stock_status` (
  `stock_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `soladaz_stock_status`
--

INSERT INTO `soladaz_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order'),
(5, 1, 'Out Of Stock'),
(6, 1, '2-3 Days');
...
--
-- Table structure for table `soladaz_store`
--

CREATE TABLE `soladaz_store` (
  `store_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Table structure for table `soladaz_tax_class`
--

CREATE TABLE `soladaz_tax_class` (
  `tax_class_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `description` varchar(255) NOT NULL,
  `date_added` datetime NOT NULL,
...
--
-- Dumping data for table `soladaz_tax_class`
--

INSERT INTO `soladaz_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `soladaz_tax_rate`
--

CREATE TABLE `soladaz_tax_rate` (
...
--
-- Dumping data for table `soladaz_tax_rate`
--

INSERT INTO `soladaz_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `soladaz_tax_rate_to_customer_group`
--

CREATE TABLE `soladaz_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_tax_rate_to_customer_group`
--

INSERT INTO `soladaz_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Table structure for table `soladaz_tax_rule`
--

CREATE TABLE `soladaz_tax_rule` (
...
--
-- Dumping data for table `soladaz_tax_rule`
--

INSERT INTO `soladaz_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121, 10, 86, 'payment', 1),
(120, 10, 87, 'store', 0),
(128, 9, 86, 'shipping', 1),
(127, 9, 87, 'shipping', 2);
...
--
-- Table structure for table `soladaz_theme`
--

CREATE TABLE `soladaz_theme` (
...
--
-- Table structure for table `soladaz_translation`
--

CREATE TABLE `soladaz_translation` (
...
--
-- Table structure for table `soladaz_upload`
--

CREATE TABLE `soladaz_upload` (
...
--
-- Table structure for table `soladaz_user`
--

CREATE TABLE `soladaz_user` (
...
--
-- Dumping data for table `soladaz_user`
--

INSERT INTO `soladaz_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', '0028409f4d307ed1ce2e30fdd7f9351f4c9754b0', '52rU2xNiM', 'John', 'Doe', 'danilonewtrue@gmail.com', '', '', '::1', 1, '2018-05-29 18:43:14');

-- --------------------------------------------------------

--
-- Table structure for table `soladaz_user_group`
--

CREATE TABLE `soladaz_user_group` (
  `user_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Dumping data for table `soladaz_user_group`
--

INSERT INTO `soladaz_user_group` (`user_group_id`, `name`, `permission`) VALUES
...
--
-- Table structure for table `soladaz_voucher`
--

CREATE TABLE `soladaz_voucher` (
  `voucher_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `code` varchar(10) NOT NULL,
  `from_name` varchar(64) NOT NULL,
...
--
-- Table structure for table `soladaz_voucher_history`
--

CREATE TABLE `soladaz_voucher_history` (
...
--
-- Table structure for table `soladaz_voucher_theme`
--

CREATE TABLE `soladaz_voucher_theme` (
  `voucher_theme_id` int(11) NOT NULL,
  `image` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_voucher_theme`
--

INSERT INTO `soladaz_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Table structure for table `soladaz_voucher_theme_description`
--

CREATE TABLE `soladaz_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `soladaz_voucher_theme_description`
--

INSERT INTO `soladaz_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, 1, 'Christmas'),
(7, 1, 'Birthday'),
(8, 1, 'General');
...
--
-- Table structure for table `soladaz_weight_class`
--

CREATE TABLE `soladaz_weight_class` (
  `weight_class_id` int(11) NOT NULL,
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `soladaz_weight_class`
--

INSERT INTO `soladaz_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- Table structure for table `soladaz_weight_class_description`
--

CREATE TABLE `soladaz_weight_class_description` (
  `weight_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `unit` varchar(4) NOT NULL
...
--
-- Dumping data for table `soladaz_weight_class_description`
--

INSERT INTO `soladaz_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz');
...
--
-- Table structure for table `soladaz_zone`
--

CREATE TABLE `soladaz_zone` (
...
--
-- Dumping data for table `soladaz_zone`
--

INSERT INTO `soladaz_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
--
-- Table structure for table `soladaz_zone_to_geo_zone`
--

CREATE TABLE `soladaz_zone_to_geo_zone` (
...
--
-- Dumping data for table `soladaz_zone_to_geo_zone`
--

INSERT INTO `soladaz_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
...
--
-- Indexes for table `soladaz_address`
--
ALTER TABLE `soladaz_address`
  ADD PRIMARY KEY (`address_id`),
  ADD KEY `customer_id` (`customer_id`);

--
-- Indexes for table `soladaz_api`
--
ALTER TABLE `soladaz_api`
  ADD PRIMARY KEY (`api_id`);

--
-- Indexes for table `soladaz_api_ip`
--
ALTER TABLE `soladaz_api_ip`
  ADD PRIMARY KEY (`api_ip_id`);

--
-- Indexes for table `soladaz_api_session`
--
ALTER TABLE `soladaz_api_session`
  ADD PRIMARY KEY (`api_session_id`);

--
-- Indexes for table `soladaz_attribute`
--
ALTER TABLE `soladaz_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Indexes for table `soladaz_attribute_description`
--
ALTER TABLE `soladaz_attribute_description`
  ADD PRIMARY KEY (`attribute_id`,`language_id`);

--
-- Indexes for table `soladaz_attribute_group`
--
ALTER TABLE `soladaz_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`);

--
-- Indexes for table `soladaz_attribute_group_description`
--
ALTER TABLE `soladaz_attribute_group_description`
  ADD PRIMARY KEY (`attribute_group_id`,`language_id`);

--
-- Indexes for table `soladaz_banner`
--
ALTER TABLE `soladaz_banner`
  ADD PRIMARY KEY (`banner_id`);

--
-- Indexes for table `soladaz_banner_image`
--
ALTER TABLE `soladaz_banner_image`
  ADD PRIMARY KEY (`banner_image_id`);

--
-- Indexes for table `soladaz_cart`
--
ALTER TABLE `soladaz_cart`
  ADD PRIMARY KEY (`cart_id`),
  ADD KEY `cart_id` (`api_id`,`customer_id`,`session_id`,`product_id`,`recurring_id`);

--
-- Indexes for table `soladaz_category`
--
ALTER TABLE `soladaz_category`
  ADD PRIMARY KEY (`category_id`),
  ADD KEY `parent_id` (`parent_id`);

--
-- Indexes for table `soladaz_category_description`
--
ALTER TABLE `soladaz_category_description`
  ADD PRIMARY KEY (`category_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `soladaz_category_filter`
--
ALTER TABLE `soladaz_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- Indexes for table `soladaz_category_path`
--
ALTER TABLE `soladaz_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- Indexes for table `soladaz_category_to_layout`
--
ALTER TABLE `soladaz_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `soladaz_category_to_store`
--
ALTER TABLE `soladaz_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `soladaz_country`
--
ALTER TABLE `soladaz_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Indexes for table `soladaz_coupon`
--
ALTER TABLE `soladaz_coupon`
  ADD PRIMARY KEY (`coupon_id`);

--
-- Indexes for table `soladaz_coupon_category`
--
ALTER TABLE `soladaz_coupon_category`
  ADD PRIMARY KEY (`coupon_id`,`category_id`);

--
-- Indexes for table `soladaz_coupon_history`
--
ALTER TABLE `soladaz_coupon_history`
  ADD PRIMARY KEY (`coupon_history_id`);

--
-- Indexes for table `soladaz_coupon_product`
--
ALTER TABLE `soladaz_coupon_product`
  ADD PRIMARY KEY (`coupon_product_id`);

--
-- Indexes for table `soladaz_currency`
--
ALTER TABLE `soladaz_currency`
  ADD PRIMARY KEY (`currency_id`);

--
-- Indexes for table `soladaz_customer`
--
ALTER TABLE `soladaz_customer`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `soladaz_customer_activity`
--
ALTER TABLE `soladaz_customer_activity`
  ADD PRIMARY KEY (`customer_activity_id`);

--
-- Indexes for table `soladaz_customer_affiliate`
--
ALTER TABLE `soladaz_customer_affiliate`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `soladaz_customer_approval`
--
ALTER TABLE `soladaz_customer_approval`
  ADD PRIMARY KEY (`customer_approval_id`);

--
-- Indexes for table `soladaz_customer_group`
--
ALTER TABLE `soladaz_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- Indexes for table `soladaz_customer_group_description`
--
ALTER TABLE `soladaz_customer_group_description`
  ADD PRIMARY KEY (`customer_group_id`,`language_id`);

--
-- Indexes for table `soladaz_customer_history`
--
ALTER TABLE `soladaz_customer_history`
  ADD PRIMARY KEY (`customer_history_id`);

--
-- Indexes for table `soladaz_customer_ip`
--
ALTER TABLE `soladaz_customer_ip`
  ADD PRIMARY KEY (`customer_ip_id`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `soladaz_customer_login`
--
ALTER TABLE `soladaz_customer_login`
  ADD PRIMARY KEY (`customer_login_id`),
  ADD KEY `email` (`email`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `soladaz_customer_online`
--
ALTER TABLE `soladaz_customer_online`
  ADD PRIMARY KEY (`ip`);

--
-- Indexes for table `soladaz_customer_reward`
--
ALTER TABLE `soladaz_customer_reward`
  ADD PRIMARY KEY (`customer_reward_id`);

--
-- Indexes for table `soladaz_customer_search`
--
ALTER TABLE `soladaz_customer_search`
  ADD PRIMARY KEY (`customer_search_id`);

--
-- Indexes for table `soladaz_customer_transaction`
--
ALTER TABLE `soladaz_customer_transaction`
  ADD PRIMARY KEY (`customer_transaction_id`);

--
-- Indexes for table `soladaz_customer_wishlist`
--
ALTER TABLE `soladaz_customer_wishlist`
  ADD PRIMARY KEY (`customer_id`,`product_id`);

--
-- Indexes for table `soladaz_custom_field`
--
ALTER TABLE `soladaz_custom_field`
  ADD PRIMARY KEY (`custom_field_id`);

--
-- Indexes for table `soladaz_custom_field_customer_group`
--
ALTER TABLE `soladaz_custom_field_customer_group`
  ADD PRIMARY KEY (`custom_field_id`,`customer_group_id`);

--
-- Indexes for table `soladaz_custom_field_description`
--
ALTER TABLE `soladaz_custom_field_description`
  ADD PRIMARY KEY (`custom_field_id`,`language_id`);

--
-- Indexes for table `soladaz_custom_field_value`
--
ALTER TABLE `soladaz_custom_field_value`
  ADD PRIMARY KEY (`custom_field_value_id`);

--
-- Indexes for table `soladaz_custom_field_value_description`
--
ALTER TABLE `soladaz_custom_field_value_description`
  ADD PRIMARY KEY (`custom_field_value_id`,`language_id`);

--
-- Indexes for table `soladaz_download`
--
ALTER TABLE `soladaz_download`
  ADD PRIMARY KEY (`download_id`);

--
-- Indexes for table `soladaz_download_description`
--
ALTER TABLE `soladaz_download_description`
  ADD PRIMARY KEY (`download_id`,`language_id`);

--
-- Indexes for table `soladaz_event`
--
ALTER TABLE `soladaz_event`
  ADD PRIMARY KEY (`event_id`);

--
-- Indexes for table `soladaz_extension`
--
ALTER TABLE `soladaz_extension`
  ADD PRIMARY KEY (`extension_id`);

--
-- Indexes for table `soladaz_extension_install`
--
ALTER TABLE `soladaz_extension_install`
  ADD PRIMARY KEY (`extension_install_id`);

--
-- Indexes for table `soladaz_extension_path`
--
ALTER TABLE `soladaz_extension_path`
  ADD PRIMARY KEY (`extension_path_id`);

--
-- Indexes for table `soladaz_filter`
--
ALTER TABLE `soladaz_filter`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `soladaz_filter_description`
--
ALTER TABLE `soladaz_filter_description`
  ADD PRIMARY KEY (`filter_id`,`language_id`);

--
-- Indexes for table `soladaz_filter_group`
--
ALTER TABLE `soladaz_filter_group`
  ADD PRIMARY KEY (`filter_group_id`);

--
-- Indexes for table `soladaz_filter_group_description`
--
ALTER TABLE `soladaz_filter_group_description`
  ADD PRIMARY KEY (`filter_group_id`,`language_id`);

--
-- Indexes for table `soladaz_geo_zone`
--
ALTER TABLE `soladaz_geo_zone`
  ADD PRIMARY KEY (`geo_zone_id`);

--
-- Indexes for table `soladaz_information`
--
ALTER TABLE `soladaz_information`
  ADD PRIMARY KEY (`information_id`);

--
-- Indexes for table `soladaz_information_description`
--
ALTER TABLE `soladaz_information_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- Indexes for table `soladaz_information_to_layout`
--
ALTER TABLE `soladaz_information_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `soladaz_information_to_store`
--
ALTER TABLE `soladaz_information_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `soladaz_language`
--
ALTER TABLE `soladaz_language`
  ADD PRIMARY KEY (`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `soladaz_layout`
--
ALTER TABLE `soladaz_layout`
  ADD PRIMARY KEY (`layout_id`);

--
-- Indexes for table `soladaz_layout_module`
--
ALTER TABLE `soladaz_layout_module`
  ADD PRIMARY KEY (`layout_module_id`);

--
-- Indexes for table `soladaz_layout_route`
--
ALTER TABLE `soladaz_layout_route`
  ADD PRIMARY KEY (`layout_route_id`);

--
-- Indexes for table `soladaz_length_class`
--
ALTER TABLE `soladaz_length_class`
  ADD PRIMARY KEY (`length_class_id`);

--
-- Indexes for table `soladaz_length_class_description`
--
ALTER TABLE `soladaz_length_class_description`
  ADD PRIMARY KEY (`length_class_id`,`language_id`);

--
-- Indexes for table `soladaz_location`
--
ALTER TABLE `soladaz_location`
  ADD PRIMARY KEY (`location_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `soladaz_manufacturer`
--
ALTER TABLE `soladaz_manufacturer`
  ADD PRIMARY KEY (`manufacturer_id`);

--
-- Indexes for table `soladaz_manufacturer_to_store`
--
ALTER TABLE `soladaz_manufacturer_to_store`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indexes for table `soladaz_marketing`
--
ALTER TABLE `soladaz_marketing`
  ADD PRIMARY KEY (`marketing_id`);

--
-- Indexes for table `soladaz_modification`
--
ALTER TABLE `soladaz_modification`
  ADD PRIMARY KEY (`modification_id`);

--
-- Indexes for table `soladaz_module`
--
ALTER TABLE `soladaz_module`
  ADD PRIMARY KEY (`module_id`);

--
-- Indexes for table `soladaz_option`
--
ALTER TABLE `soladaz_option`
  ADD PRIMARY KEY (`option_id`);

--
-- Indexes for table `soladaz_option_description`
--
ALTER TABLE `soladaz_option_description`
  ADD PRIMARY KEY (`option_id`,`language_id`);

--
-- Indexes for table `soladaz_option_value`
--
ALTER TABLE `soladaz_option_value`
  ADD PRIMARY KEY (`option_value_id`);

--
-- Indexes for table `soladaz_option_value_description`
--
ALTER TABLE `soladaz_option_value_description`
  ADD PRIMARY KEY (`option_value_id`,`language_id`);

--
-- Indexes for table `soladaz_order`
--
ALTER TABLE `soladaz_order`
  ADD PRIMARY KEY (`order_id`);

--
-- Indexes for table `soladaz_order_history`
--
ALTER TABLE `soladaz_order_history`
  ADD PRIMARY KEY (`order_history_id`);

--
-- Indexes for table `soladaz_order_option`
--
ALTER TABLE `soladaz_order_option`
  ADD PRIMARY KEY (`order_option_id`);

--
-- Indexes for table `soladaz_order_product`
--
ALTER TABLE `soladaz_order_product`
  ADD PRIMARY KEY (`order_product_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `soladaz_order_recurring`
--
ALTER TABLE `soladaz_order_recurring`
  ADD PRIMARY KEY (`order_recurring_id`);

--
-- Indexes for table `soladaz_order_recurring_transaction`
--
ALTER TABLE `soladaz_order_recurring_transaction`
  ADD PRIMARY KEY (`order_recurring_transaction_id`);

--
-- Indexes for table `soladaz_order_shipment`
--
ALTER TABLE `soladaz_order_shipment`
  ADD PRIMARY KEY (`order_shipment_id`);

--
-- Indexes for table `soladaz_order_status`
--
ALTER TABLE `soladaz_order_status`
  ADD PRIMARY KEY (`order_status_id`,`language_id`);

--
-- Indexes for table `soladaz_order_total`
--
ALTER TABLE `soladaz_order_total`
  ADD PRIMARY KEY (`order_total_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `soladaz_order_voucher`
--
ALTER TABLE `soladaz_order_voucher`
  ADD PRIMARY KEY (`order_voucher_id`);

--
-- Indexes for table `soladaz_product`
--
ALTER TABLE `soladaz_product`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `soladaz_product_attribute`
--
ALTER TABLE `soladaz_product_attribute`
  ADD PRIMARY KEY (`product_id`,`attribute_id`,`language_id`);

--
-- Indexes for table `soladaz_product_description`
--
ALTER TABLE `soladaz_product_description`
  ADD PRIMARY KEY (`product_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `soladaz_product_discount`
--
ALTER TABLE `soladaz_product_discount`
  ADD PRIMARY KEY (`product_discount_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `soladaz_product_filter`
--
ALTER TABLE `soladaz_product_filter`
  ADD PRIMARY KEY (`product_id`,`filter_id`);

--
-- Indexes for table `soladaz_product_image`
--
ALTER TABLE `soladaz_product_image`
  ADD PRIMARY KEY (`product_image_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `soladaz_product_option`
--
ALTER TABLE `soladaz_product_option`
  ADD PRIMARY KEY (`product_option_id`);

--
-- Indexes for table `soladaz_product_option_value`
--
ALTER TABLE `soladaz_product_option_value`
  ADD PRIMARY KEY (`product_option_value_id`);

--
-- Indexes for table `soladaz_product_recurring`
--
ALTER TABLE `soladaz_product_recurring`
  ADD PRIMARY KEY (`product_id`,`recurring_id`,`customer_group_id`);

--
-- Indexes for table `soladaz_product_related`
--
ALTER TABLE `soladaz_product_related`
  ADD PRIMARY KEY (`product_id`,`related_id`);

--
-- Indexes for table `soladaz_product_reward`
--
ALTER TABLE `soladaz_product_reward`
  ADD PRIMARY KEY (`product_reward_id`);

--
-- Indexes for table `soladaz_product_special`
--
ALTER TABLE `soladaz_product_special`
  ADD PRIMARY KEY (`product_special_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `soladaz_product_to_category`
--
ALTER TABLE `soladaz_product_to_category`
  ADD PRIMARY KEY (`product_id`,`category_id`),
  ADD KEY `category_id` (`category_id`);

--
-- Indexes for table `soladaz_product_to_download`
--
ALTER TABLE `soladaz_product_to_download`
  ADD PRIMARY KEY (`product_id`,`download_id`);

--
-- Indexes for table `soladaz_product_to_layout`
--
ALTER TABLE `soladaz_product_to_layout`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `soladaz_product_to_store`
--
ALTER TABLE `soladaz_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `soladaz_recurring`
--
ALTER TABLE `soladaz_recurring`
  ADD PRIMARY KEY (`recurring_id`);

--
-- Indexes for table `soladaz_recurring_description`
--
ALTER TABLE `soladaz_recurring_description`
  ADD PRIMARY KEY (`recurring_id`,`language_id`);

--
-- Indexes for table `soladaz_return`
--
ALTER TABLE `soladaz_return`
  ADD PRIMARY KEY (`return_id`);

--
-- Indexes for table `soladaz_return_action`
--
ALTER TABLE `soladaz_return_action`
  ADD PRIMARY KEY (`return_action_id`,`language_id`);

--
-- Indexes for table `soladaz_return_history`
--
ALTER TABLE `soladaz_return_history`
  ADD PRIMARY KEY (`return_history_id`);

--
-- Indexes for table `soladaz_return_reason`
--
ALTER TABLE `soladaz_return_reason`
  ADD PRIMARY KEY (`return_reason_id`,`language_id`);

--
-- Indexes for table `soladaz_return_status`
--
ALTER TABLE `soladaz_return_status`
  ADD PRIMARY KEY (`return_status_id`,`language_id`);

--
-- Indexes for table `soladaz_review`
--
ALTER TABLE `soladaz_review`
  ADD PRIMARY KEY (`review_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `soladaz_seo_url`
--
ALTER TABLE `soladaz_seo_url`
  ADD PRIMARY KEY (`seo_url_id`),
  ADD KEY `query` (`query`),
  ADD KEY `keyword` (`keyword`);

--
-- Indexes for table `soladaz_session`
--
ALTER TABLE `soladaz_session`
  ADD PRIMARY KEY (`session_id`);

--
-- Indexes for table `soladaz_setting`
--
ALTER TABLE `soladaz_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Indexes for table `soladaz_shipping_courier`
--
ALTER TABLE `soladaz_shipping_courier`
  ADD PRIMARY KEY (`shipping_courier_id`);

--
-- Indexes for table `soladaz_simple_blog_category`
--
ALTER TABLE `soladaz_simple_blog_category`
  ADD PRIMARY KEY (`simple_blog_category_id`);

--
-- Indexes for table `soladaz_simple_blog_category_description`
--
ALTER TABLE `soladaz_simple_blog_category_description`
  ADD PRIMARY KEY (`simple_blog_category_description_id`);

--
-- Indexes for table `soladaz_soconfig`
--
ALTER TABLE `soladaz_soconfig`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `soladaz_statistics`
--
ALTER TABLE `soladaz_statistics`
  ADD PRIMARY KEY (`statistics_id`);

--
-- Indexes for table `soladaz_stock_status`
--
ALTER TABLE `soladaz_stock_status`
  ADD PRIMARY KEY (`stock_status_id`,`language_id`);

--
-- Indexes for table `soladaz_store`
--
ALTER TABLE `soladaz_store`
  ADD PRIMARY KEY (`store_id`);

--
-- Indexes for table `soladaz_tax_class`
--
ALTER TABLE `soladaz_tax_class`
  ADD PRIMARY KEY (`tax_class_id`);

--
-- Indexes for table `soladaz_tax_rate`
--
ALTER TABLE `soladaz_tax_rate`
  ADD PRIMARY KEY (`tax_rate_id`);

--
-- Indexes for table `soladaz_tax_rate_to_customer_group`
--
ALTER TABLE `soladaz_tax_rate_to_customer_group`
  ADD PRIMARY KEY (`tax_rate_id`,`customer_group_id`);

--
-- Indexes for table `soladaz_tax_rule`
--
ALTER TABLE `soladaz_tax_rule`
  ADD PRIMARY KEY (`tax_rule_id`);

--
-- Indexes for table `soladaz_theme`
--
ALTER TABLE `soladaz_theme`
  ADD PRIMARY KEY (`theme_id`);

--
-- Indexes for table `soladaz_translation`
--
ALTER TABLE `soladaz_translation`
  ADD PRIMARY KEY (`translation_id`);

--
-- Indexes for table `soladaz_upload`
--
ALTER TABLE `soladaz_upload`
  ADD PRIMARY KEY (`upload_id`);

--
-- Indexes for table `soladaz_user`
--
ALTER TABLE `soladaz_user`
  ADD PRIMARY KEY (`user_id`);

--
-- Indexes for table `soladaz_user_group`
--
ALTER TABLE `soladaz_user_group`
  ADD PRIMARY KEY (`user_group_id`);

--
-- Indexes for table `soladaz_voucher`
--
ALTER TABLE `soladaz_voucher`
  ADD PRIMARY KEY (`voucher_id`);

--
-- Indexes for table `soladaz_voucher_history`
--
ALTER TABLE `soladaz_voucher_history`
  ADD PRIMARY KEY (`voucher_history_id`);

--
-- Indexes for table `soladaz_voucher_theme`
--
ALTER TABLE `soladaz_voucher_theme`
  ADD PRIMARY KEY (`voucher_theme_id`);

--
-- Indexes for table `soladaz_voucher_theme_description`
--
ALTER TABLE `soladaz_voucher_theme_description`
  ADD PRIMARY KEY (`voucher_theme_id`,`language_id`);

--
-- Indexes for table `soladaz_weight_class`
--
ALTER TABLE `soladaz_weight_class`
  ADD PRIMARY KEY (`weight_class_id`);

--
-- Indexes for table `soladaz_weight_class_description`
--
ALTER TABLE `soladaz_weight_class_description`
  ADD PRIMARY KEY (`weight_class_id`,`language_id`);

--
-- Indexes for table `soladaz_zone`
--
ALTER TABLE `soladaz_zone`
  ADD PRIMARY KEY (`zone_id`);

--
-- Indexes for table `soladaz_zone_to_geo_zone`
--
ALTER TABLE `soladaz_zone_to_geo_zone`
...
--
-- AUTO_INCREMENT for table `soladaz_address`
--
ALTER TABLE `soladaz_address`
  MODIFY `address_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_api`
--
ALTER TABLE `soladaz_api`
  MODIFY `api_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `soladaz_api_ip`
--
ALTER TABLE `soladaz_api_ip`
  MODIFY `api_ip_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_api_session`
--
ALTER TABLE `soladaz_api_session`
  MODIFY `api_session_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_attribute`
--
ALTER TABLE `soladaz_attribute`
  MODIFY `attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `soladaz_attribute_group`
--
ALTER TABLE `soladaz_attribute_group`
  MODIFY `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `soladaz_banner`
--
ALTER TABLE `soladaz_banner`
  MODIFY `banner_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `soladaz_banner_image`
--
ALTER TABLE `soladaz_banner_image`
  MODIFY `banner_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
--
-- AUTO_INCREMENT for table `soladaz_cart`
--
ALTER TABLE `soladaz_cart`
  MODIFY `cart_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_category`
--
ALTER TABLE `soladaz_category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
--
-- AUTO_INCREMENT for table `soladaz_country`
--
ALTER TABLE `soladaz_country`
  MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;
--
-- AUTO_INCREMENT for table `soladaz_coupon`
--
ALTER TABLE `soladaz_coupon`
  MODIFY `coupon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `soladaz_coupon_history`
--
ALTER TABLE `soladaz_coupon_history`
  MODIFY `coupon_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_coupon_product`
--
ALTER TABLE `soladaz_coupon_product`
  MODIFY `coupon_product_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_currency`
--
ALTER TABLE `soladaz_currency`
  MODIFY `currency_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `soladaz_customer`
--
ALTER TABLE `soladaz_customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_customer_activity`
--
ALTER TABLE `soladaz_customer_activity`
  MODIFY `customer_activity_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_customer_approval`
--
ALTER TABLE `soladaz_customer_approval`
  MODIFY `customer_approval_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_customer_group`
--
ALTER TABLE `soladaz_customer_group`
  MODIFY `customer_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `soladaz_customer_history`
--
ALTER TABLE `soladaz_customer_history`
  MODIFY `customer_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_customer_ip`
--
ALTER TABLE `soladaz_customer_ip`
  MODIFY `customer_ip_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_customer_login`
--
ALTER TABLE `soladaz_customer_login`
  MODIFY `customer_login_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_customer_reward`
--
ALTER TABLE `soladaz_customer_reward`
  MODIFY `customer_reward_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_customer_search`
--
ALTER TABLE `soladaz_customer_search`
  MODIFY `customer_search_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_customer_transaction`
--
ALTER TABLE `soladaz_customer_transaction`
  MODIFY `customer_transaction_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_custom_field`
--
ALTER TABLE `soladaz_custom_field`
  MODIFY `custom_field_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_custom_field_value`
--
ALTER TABLE `soladaz_custom_field_value`
  MODIFY `custom_field_value_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_download`
--
ALTER TABLE `soladaz_download`
  MODIFY `download_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_event`
--
ALTER TABLE `soladaz_event`
  MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
-- AUTO_INCREMENT for table `soladaz_extension`
--
ALTER TABLE `soladaz_extension`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
--
-- AUTO_INCREMENT for table `soladaz_extension_install`
--
ALTER TABLE `soladaz_extension_install`
  MODIFY `extension_install_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_extension_path`
--
ALTER TABLE `soladaz_extension_path`
  MODIFY `extension_path_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_filter`
--
ALTER TABLE `soladaz_filter`
  MODIFY `filter_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_filter_group`
--
ALTER TABLE `soladaz_filter_group`
  MODIFY `filter_group_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_geo_zone`
--
ALTER TABLE `soladaz_geo_zone`
  MODIFY `geo_zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `soladaz_information`
--
ALTER TABLE `soladaz_information`
  MODIFY `information_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `soladaz_language`
--
ALTER TABLE `soladaz_language`
  MODIFY `language_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `soladaz_layout`
--
ALTER TABLE `soladaz_layout`
  MODIFY `layout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `soladaz_layout_module`
--
ALTER TABLE `soladaz_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4128;
--
-- AUTO_INCREMENT for table `soladaz_layout_route`
--
ALTER TABLE `soladaz_layout_route`
  MODIFY `layout_route_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT for table `soladaz_length_class`
--
ALTER TABLE `soladaz_length_class`
  MODIFY `length_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `soladaz_location`
--
ALTER TABLE `soladaz_location`
  MODIFY `location_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_manufacturer`
--
ALTER TABLE `soladaz_manufacturer`
  MODIFY `manufacturer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `soladaz_marketing`
--
ALTER TABLE `soladaz_marketing`
  MODIFY `marketing_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_modification`
--
ALTER TABLE `soladaz_modification`
  MODIFY `modification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `soladaz_module`
--
ALTER TABLE `soladaz_module`
  MODIFY `module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;
--
-- AUTO_INCREMENT for table `soladaz_option`
--
ALTER TABLE `soladaz_option`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `soladaz_option_value`
--
ALTER TABLE `soladaz_option_value`
  MODIFY `option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT for table `soladaz_order`
--
ALTER TABLE `soladaz_order`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_order_history`
--
ALTER TABLE `soladaz_order_history`
  MODIFY `order_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_order_option`
--
ALTER TABLE `soladaz_order_option`
  MODIFY `order_option_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_order_product`
--
ALTER TABLE `soladaz_order_product`
  MODIFY `order_product_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_order_recurring`
--
ALTER TABLE `soladaz_order_recurring`
  MODIFY `order_recurring_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_order_recurring_transaction`
--
ALTER TABLE `soladaz_order_recurring_transaction`
  MODIFY `order_recurring_transaction_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_order_shipment`
--
ALTER TABLE `soladaz_order_shipment`
  MODIFY `order_shipment_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_order_status`
--
ALTER TABLE `soladaz_order_status`
  MODIFY `order_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `soladaz_order_total`
--
ALTER TABLE `soladaz_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_order_voucher`
--
ALTER TABLE `soladaz_order_voucher`
  MODIFY `order_voucher_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_product`
--
ALTER TABLE `soladaz_product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
--
-- AUTO_INCREMENT for table `soladaz_product_discount`
--
ALTER TABLE `soladaz_product_discount`
  MODIFY `product_discount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=441;
--
-- AUTO_INCREMENT for table `soladaz_product_image`
--
ALTER TABLE `soladaz_product_image`
  MODIFY `product_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2352;
--
-- AUTO_INCREMENT for table `soladaz_product_option`
--
ALTER TABLE `soladaz_product_option`
  MODIFY `product_option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;
--
-- AUTO_INCREMENT for table `soladaz_product_option_value`
--
ALTER TABLE `soladaz_product_option_value`
  MODIFY `product_option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `soladaz_product_reward`
--
ALTER TABLE `soladaz_product_reward`
  MODIFY `product_reward_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=546;
--
-- AUTO_INCREMENT for table `soladaz_product_special`
--
ALTER TABLE `soladaz_product_special`
  MODIFY `product_special_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=440;
--
-- AUTO_INCREMENT for table `soladaz_recurring`
--
ALTER TABLE `soladaz_recurring`
  MODIFY `recurring_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_return`
--
ALTER TABLE `soladaz_return`
  MODIFY `return_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_return_action`
--
ALTER TABLE `soladaz_return_action`
  MODIFY `return_action_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `soladaz_return_history`
--
ALTER TABLE `soladaz_return_history`
  MODIFY `return_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_return_reason`
--
ALTER TABLE `soladaz_return_reason`
  MODIFY `return_reason_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `soladaz_return_status`
--
ALTER TABLE `soladaz_return_status`
  MODIFY `return_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `soladaz_review`
--
ALTER TABLE `soladaz_review`
  MODIFY `review_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_seo_url`
--
ALTER TABLE `soladaz_seo_url`
  MODIFY `seo_url_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=844;
--
-- AUTO_INCREMENT for table `soladaz_setting`
--
ALTER TABLE `soladaz_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8027;
--
-- AUTO_INCREMENT for table `soladaz_simple_blog_category`
--
ALTER TABLE `soladaz_simple_blog_category`
  MODIFY `simple_blog_category_id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `soladaz_simple_blog_category_description`
--
ALTER TABLE `soladaz_simple_blog_category_description`
  MODIFY `simple_blog_category_description_id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `soladaz_soconfig`
--
ALTER TABLE `soladaz_soconfig`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71335;
--
-- AUTO_INCREMENT for table `soladaz_statistics`
--
ALTER TABLE `soladaz_statistics`
  MODIFY `statistics_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `soladaz_stock_status`
--
ALTER TABLE `soladaz_stock_status`
  MODIFY `stock_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `soladaz_store`
--
ALTER TABLE `soladaz_store`
  MODIFY `store_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_tax_class`
--
ALTER TABLE `soladaz_tax_class`
  MODIFY `tax_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `soladaz_tax_rate`
--
ALTER TABLE `soladaz_tax_rate`
  MODIFY `tax_rate_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
--
-- AUTO_INCREMENT for table `soladaz_tax_rule`
--
ALTER TABLE `soladaz_tax_rule`
  MODIFY `tax_rule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
--
-- AUTO_INCREMENT for table `soladaz_theme`
--
ALTER TABLE `soladaz_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_translation`
--
ALTER TABLE `soladaz_translation`
  MODIFY `translation_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_upload`
--
ALTER TABLE `soladaz_upload`
  MODIFY `upload_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_user`
--
ALTER TABLE `soladaz_user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `soladaz_user_group`
--
ALTER TABLE `soladaz_user_group`
  MODIFY `user_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `soladaz_voucher`
--
ALTER TABLE `soladaz_voucher`
  MODIFY `voucher_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_voucher_history`
--
ALTER TABLE `soladaz_voucher_history`
  MODIFY `voucher_history_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `soladaz_voucher_theme`
--
ALTER TABLE `soladaz_voucher_theme`
  MODIFY `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `soladaz_weight_class`
--
ALTER TABLE `soladaz_weight_class`
  MODIFY `weight_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `soladaz_zone`
--
ALTER TABLE `soladaz_zone`
  MODIFY `zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4239;
--
-- AUTO_INCREMENT for table `soladaz_zone_to_geo_zone`
--
ALTER TABLE `soladaz_zone_to_geo_zone`
